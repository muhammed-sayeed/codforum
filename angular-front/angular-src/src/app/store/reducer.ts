import { authStateInterface } from "../types/state.interface";
...
import { userListAction, userlistFailureAction, userListSuccessAction } from "./action/userlist.action";
import { state } from "@angular/animations";
import { tagListAction, tagListFailureAction, tagListSuccessAction } from "./action/taglist";
import { moderatorListAction, moderatorListFailureAction, moderatorListSuccessAction } from "./action/moderatorlist";
import { communityListAction, communityListFailureAction, communityListSuccessAction } from "./action/community";
import { badgeListAction, badgeListFailureAction, badgeListSuccessAction } from "./action/badgelist";
import { userProfileAction, userProfileFailureAction, userProfileSuccessAction } from "./action/userprofile";
import { usersAction, usersFailureAction, usersSuccessAction } from "./action/useractions";
